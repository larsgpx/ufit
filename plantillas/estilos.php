...
<?php 
  $result                 = $db_Full->select_sql("SELECT * from tbl_estilos ");
  $ro                     = mysqli_fetch_assoc($result);
  $foto                   = $ro['foto_estilo'];
  $descripcion            = $ro['des_estilo'];
?>

<!--MARCAS-->
<div class="base_estilos">
	<div class="estilos" style="background-image: url(<?php echo $BASE_URL."webroot/archivos/".$foto; ?>);">
