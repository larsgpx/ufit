        ...
        <div class="row">
            <div class="col-sm-10 col-sm-offset-1">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-6">
                        <div class="circle text-center pull-left"><?php echo $n;?></div><a href="#" onclick="preguntas(<?php echo $row10['id_tema'];?>);"><h4><?php echo $row10['titulo_tema'];?></h4></a>
                        <ul>
                            ...
                            <li><a href="#" onclick="preguntas(<?php echo $row100['fktema_pre'];?>);"><?php echo $row100['titulo_pre'];?></a></li>
