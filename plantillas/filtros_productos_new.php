                            ...
                            <ul class="dropdown-menu" aria-labelledby="filtroTalla">
                                ...
                                if($row2['_id_categoria'] != 0)
                                {
                                        ...
                                        while ($row222 = mysqli_fetch_assoc($result222)){
                                            ...
                                            echo '<li>';
                                            if(isset($id_cat)){?>
                                                    <span data_link="link_row" data="<?php echo $row2["id_filtro"];?>" tipo = "<?php echo $id_tipo;?>" data2="<?php echo $row222["id_item_categoria"];?>" categoria="<?php echo  $id_cat;?>" marca="0" subcategoria="<?php echo  $id_page_table;?>" cantidades="<?php echo $cantidad_paginador;?>" onclick="captar_filtro(this);" onclick2="setCookie('filtro_<?php echo $i?>','<?php echo $row222["nombre_item_categoria"]; ?>','1')"><?php echo ucfirst(strtolower($row222["nombre_item_categoria"])); ?>
                                                    </span>
                                            <?php }
                                            else{?>   
