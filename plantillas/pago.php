    ...
    $('.payButton').on('click', function(e){
        ...
        //window.location.href = "checkout.php?p=" + formOfPayment;
         ...
         $.ajax({
             ...
             { 
                  $.fancybox("#gracias_popup_venta");
                  setTimeout("location.href='detalle-cuenta'", 2000);
             }
           });
    });
...
function validando_pago()
{
     ...
     $.ajax({
                  ...
                  success: function(data)
                  {
                      ...
                      //$.fancybox("#gracias_popup_venta");
                      setTimeout("location.href='detalle_cuenta'", 2000);
      ...
      <div id="reacionadosCarousel" class="carousel slide">
        ...
        <div class="carousel-inner fuente_georgia">
          ...
          if ($carro != '' && $cantidad>0) 
          {
                        if($cantidad==1)
                        {
                            $result201 = $db_Full->select_sql("SELECT titulo_producto,foto_producto,nombre_marca,oferta_producto,precio_producto,descuento_producto,tbl_productos.url_page_tbl FROM tbl_relacionar_productos,tbl_productos,tbl_marcas,tbl_productos_marcas WHERE  fkproducto1_re_pro=".$array_producto[0]." AND fkproducto2_re_pro=id_producto and  fkproducto_productos_marcas=id_producto and   fkmarca_productos_marcas=id_marca limit 5");
                             ...
                             <div class="item active" >
                                            <div class="row-fluid">
                                                  <div class="span3">
                                                        ...
                                                        <h4 class="text-center section-title font_size14">
                                                          <?php echo $row201['titulo_producto'];?>
                                                          <br>
                                                          <?php echo $row201['nombre_marca'];?>
                                                        </h4>
                                                        <p class="text-center">Orig. S/. <?php echo $row201['precio_producto'];?>
                                                            ...
                                                            {
                                                            ?>
                                                            <br><span class="text-danger">Oferta S/. <?php echo $row201['precio_producto'] - ($row201['precio_producto']*$row201['descuento_producto']/100);?>
                                                            </span>
                                                            <?php  
                                                            }
                                                            ?>
                        ...
                        {
                           $result201 = $db_Full->select_sql("SELECT titulo_producto,foto_producto,nombre_marca,oferta_producto,precio_producto,descuento_producto,tbl_productos.url_page_tbl FROM tbl_relacionar_productos,tbl_productos,tbl_marcas,tbl_productos_marcas WHERE  fkproducto1_re_pro=".$array_producto[0]." AND fkproducto2_re_pro=id_producto and  fkproducto_productos_marcas=id_producto and   fkmarca_productos_marcas=id_marca limit 3");
                            while ($row201 = mysqli_fetch_array($result201))
                            {
                            ?>
                                 <div class="item active" >
                            ...
                            $result202 = $db_Full->select_sql("SELECT titulo_producto,foto_producto,nombre_marca,oferta_producto,precio_producto,descuento_producto,tbl_productos.url_page_tbl FROM tbl_relacionar_productos,tbl_productos,tbl_marcas,tbl_productos_marcas WHERE  fkproducto1_re_pro=".$array_producto[1]." AND fkproducto2_re_pro=id_producto and fkproducto_productos_marcas=id_producto and   fkmarca_productos_marcas=id_marca limit 2");
                             ...
                             <div class="item active" >
                                            <div class="row-fluid">
                                                  <div class="span3">
                                                        ...
                                                        <h4 class="text-center section-title font_size14">
                                                          <?php echo $row202['titulo_producto'];?>
                                                          <br>
                                                          <?php echo $row202['nombre_marca'];?>
                                                        </h4>
                                                        <p class="text-center">Orig. S/. <?php echo $row202['precio_producto'];?>
                                                            ...
                                                            {
                                                            ?>
                                                            <br><span class="text-danger">Oferta S/. <?php echo $row202['precio_producto'] - ($row202['precio_producto']*$row202['descuento_producto']/100);?>
                                                            </span>
                                                            <?php  
                                                            }
                                                            ?>
                        ...
                        }else
                        {
                            ...
                            $result201 = $db_Full->select_sql("SELECT titulo_producto,foto_producto,nombre_marca,oferta_producto,precio_producto,descuento_producto,tbl_productos.url_page_tbl FROM tbl_relacionar_productos,tbl_productos,tbl_marcas,tbl_productos_marcas WHERE  fkproducto1_re_pro=".$array_producto[0]." AND fkproducto2_re_pro=id_producto and fkproducto_productos_marcas=id_producto and   fkmarca_productos_marcas=id_marca limit 2");
                            while ($row201 = mysqli_fetch_array($result201))
                            {
                            ?>
                             <div class="item active" >
                            ...
                            $result203 = $db_Full->select_sql("SELECT titulo_producto,foto_producto,nombre_marca,oferta_producto,precio_producto,descuento_producto,tbl_productos.url_page_tbl FROM tbl_relacionar_productos,tbl_productos,tbl_marcas,tbl_productos_marcas WHERE  fkproducto1_re_pro=".$array_producto[2]." AND fkproducto2_re_pro=id_producto and fkproducto_productos_marcas=id_producto and   fkmarca_productos_marcas=id_marca limit 1");
                             ...
                             <div class="item active" >
                                            <div class="row-fluid">
                                                  <div class="span3">
                                                        ...
                                                        <h4 class="text-center section-title font_size14">
                                                        <?php echo $row203['titulo_producto'];?>
                                                        <br>
                                                          <?php echo $row203['nombre_marca'];?>
                                                        </h4>
                                                        <p class="text-center">Orig. S/. <?php echo $row203['precio_producto'];?>
                                                            ...
                                                            {
                                                            ?>
                                                            <br><span class="text-danger">Sale S/. <?php echo $row203['precio_producto'] - ($row203['precio_producto']*$row203['descuento_producto']/100);?>
                                                            </span>
                                                            <?php  
                                                            }
                                                            ?>
