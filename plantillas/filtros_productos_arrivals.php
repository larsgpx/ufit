                            ...
                            <ul class="dropdown-menu" aria-labelledby="filtroTalla">
                                ...
                                if($row2["nombre_filtro"] != "Marca")
                                {
                                    ...
                                    $result3 = $db_Full->select_sql("SELECT * 
                                                                     FROM tbl_filtros,tbl_items_filtro 
                                    ...
                                    if(mysqli_num_rows($result3))
                                    {
                                        ...
                                        ?>
                                        <li>
                                                <span data_link="link_row" data="<?php echo $row2["id_filtro"];?>" tipo = "<?php echo $id_tipo;?>" data2="<?php echo $row3["id_item_filtro"];?>" persona="<?php echo $id_tipo_persona; ?>" categoria="" marca="0" subcategoria="" cantidades="0" onclick="captar_filtro_arrivals(this);" onclick2="setCookie('filtro_<?php echo $i?>','<?php echo $row3["nombre_item_filtro"]; ?>','1')"><?php echo ucfirst(strtolower($row3["nombre_item_filtro"])); ?>
                                                </span>
                                        </li>
                                        <?php
                                        }
                                        ...
                                        if($row2['_id_categoria'] != 0)
                                        {
                                            ...
                                            while ($row222 = mysqli_fetch_assoc($result222)){
                                              $url3 = $row222["url_page_tbl"];
                                               ?>  
                                                    <li>
                                                            <span href="<?php echo $BASE_URL.$url3;?>" data_link="link_row" tipo = "<?php echo $id_tipo;?>" data="<?php echo $row2["id_filtro"];?>" categoria="<?php echo  $id_cat;?>" subcategoria="<?php echo $row222['id_item_categoria'];?>" persona="<?php echo $id_tipo_persona; ?>" cantidades="<?php echo $cantidad_paginador;?>"  data2="<?php echo $row3["id_item_filtro"];?>" marca="<?php echo $row_subf["id_marca"]; ?>"  onclick="captar_filtro_arrivals(this);">
                                                                <?php echo ucfirst(strtolower($row222["nombre_item_categoria"]));?>
                                                            </span>
                                                    </li>
                                              <?php          
                                            }
                                                ...
                                                $resultf = $db_Full->select_sql("select tbl_marcas.url_page_tbl,
                                                                    ...
                                                                    tbl_productos where fkmarca_productos_marcas =id_marca and fktipo_productos_marcas=".$id_tipo." and
                                                          ...
                                                          ?>  
                                                                <li>
                                                                    <span href="<?php echo $BASE_URL.$url3;?>" data_link="link_row" tipo = "<?php echo $id_tipo;?>" data="<?php echo $row2["id_filtro"];?>" categoria="<?php echo  $id_cat;?>" subcategoria="<?php echo  $id_page_table;?>" persona="<?php echo $id_tipo_persona; ?>" cantidades="<?php echo $cantidad_paginador;?>"  data2="<?php echo $row3["id_item_filtro"];?>" marca="<?php echo $row_subf["id_marca"]; ?>"  onclick="captar_filtro_arrivals(this);"><?php echo ucfirst(strtolower($row_subf["nombre_marca"])); ?>
                                                                    </span>
                                                                </li>
                                                          <?php
                                                          }           
