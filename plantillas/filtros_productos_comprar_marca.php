                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="filtroTalla">
                                ...
                                if($row2["nombre_filtro"]!="Marca")
                                {
                                    ...
                                    if(mysqli_num_rows($result3))
                                    {
                                        ...
                                        <li>
                                                ...
                                                <span data_link="link_row" data="<?php echo $row2["id_filtro"];?>" tipo = "<?php echo $id_tipo;?>" data2="<?php echo $row3["id_item_filtro"];?>" categoria="" marca="0" subcategoria="" cantidades="0" onclick="captar_filtro_comprar_marca(this);" onclick2="setCookie('filtro_<?php echo $i?>','<?php echo $row3["nombre_item_filtro"]; ?>','1')"><?php echo ucfirst(strtolower($row3["nombre_item_filtro"])); ?>
                                                </span>
                                ...
                                {   
                                                        ...
                                                        $resultf = $db_Full->select_sql("select tbl_marcas.url_page_tbl,nombre_marca,id_marca from tbl_marcas,tbl_productos_marcas,tbl_productos where fkmarca_productos_marcas =id_marca and fktipo_productos_marcas=".$id_tipo." and  fkproducto_productos_marcas =tbl_productos.id_producto group by id_marca"); 
                                                          ...
                                                          ?>  
                                                                <li>
                                                                    <span href="<?php echo $BASE_URL.$url3;?>" data_link="link_row" tipo = "<?php echo $id_tipo;?>" data="<?php echo $row2["id_filtro"];?>" categoria="<?php echo  $id_cat;?>" subcategoria="<?php echo  $id_page_table;?>" cantidades="<?php echo $cantidad_paginador;?>" subcategoria="<?php echo  $id_page_table;?>" data2="<?php echo $row3["id_item_filtro"];?>" marca="<?php echo $row_subf["id_marca"]; ?>"  onclick="captar_filtro_comprar_marca(this);"><?php echo ucfirst(strtolower($row_subf["nombre_marca"])); ?>
                                                                    </span>
                                                                </li>
                                                          <?php
                                                          }           
