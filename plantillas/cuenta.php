                      ...
                      if(data==1)
                      {
                           $("#inline").css("display", "none");
                            $.fancybox("#gracias");
                             ...
                             setTimeout("location.href='cuenta'", 2000);
                      }
                      else
                      {
         ...
         $.ajax({
                  ...
                  success: function(data)
                  {
                      ...
                      }else if(data==2)
                      {
                          <?php
                          if($producto=="1"){
                              echo 'window.location.assign("pago")';
                          }else{
                      ...
                      {
                          window.location.assign("detalle-cuenta");
                      }
...
<div class="left_crear_cuenta">
    ...
    <input type="hidden" name="producto" id="producto" value="<?php echo $producto; ?>" style="width:100%; border:solid 1px #000; height:25px">
