...
<script>
	...
	function validando_novedades()
	{
		...
		}else
		{
		 ...
		 $.ajax({
				  type: "POST",
				  url: "enviar_novedades_home.php",
				  data : "email_1="+$('#email_1').val(),	 
				  success: function(data)
				  {
					 	
				      $.fancybox("#gracias_popup");
					  setTimeout("location.href='registro-novedades'", 2000);
...
<tr>
<td align="left" class="fuente_georgia font_size18" style="background-color:#000; color:#FFF; padding:15px">REGISTRO A ENVÍO DE NOVEDADES</td>
</tr>
<tr>
<td height="20"></td>
</tr>
<tr>
<td align="left" class="fuente_georgia font_size12" style="color:#000">Mantente en contacto con ROYALTY.PE a través de tu correo electrónico para enviarle lo último de la moda, ofertas, novedades, eventos y mucho más.</td>
</tr>
</table>
...
<div class="right_crear_cuenta">
    ...
    <tr><td height="20"></td></tr>
    <tr>
    <td align="center"><input type="submit" onclick="return validando_novedades()" style="cursor:pointer"  class="boton_crear_cuenta fuente_georgia font_size12" value="ENVIAR"></td>
    </tr>
    </table>
</div>
</form>
