		...
		}else
		{
		 ...
		 $.ajax({
				  ...
				  success: function(data)
				  {
					  ...
					  setTimeout("location.href='registro-ofertas'", 2000);
...
<tr>
<td align="left" class="fuente_georgia font_size18" style="background-color:#000; color:#FFF; padding:15px">REGISTRO A ENVÍO DE OFERTAS</td>
</tr>
<tr>
<td height="20"></td>
</tr>
...
<div class="right_crear_cuenta">
    ...
    <tr><td height="20"></td></tr>
    <tr>
    <td align="center"><input type="submit" onclick="return validando_ofertas()" style="cursor:pointer"  class="boton_crear_cuenta fuente_georgia font_size12" value="ENVIAR"></td>
    </tr>
    </table>
</div>
</form>
