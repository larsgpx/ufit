...
<script>
	...
	function validando_vista_email()
	{
		...
		}else
		{
		 ...
		 $.ajax({
				  ...
				  success: function(data)
				  {
					  ...
					  setTimeout("location.href='registro-email'", 2000);
...
<div class="right_crear_cuenta">
    ...
    <tr><td height="20"></td></tr>
    <tr>
    <td align="center"><input type="submit" onclick="return validando_vista_email()" style="cursor:pointer"  class="boton_crear_cuenta fuente_georgia font_size12" value="ENVIAR"></td>
    </tr>
    </table>
</div>
</form>
