                ...
                <ul class="list-inline">
                            ...
                            if($row2['_id_categoria'] != 0)
                                {   
                                     $result3   = $db_Full->select_sql("SELECT icat.id_item_categoria,
                                      ...
                                      $result3 = $db_Full->select_sql("SELECT * FROM
                                                                       tbl_filtros,tbl_items_filtro 
                 ...
                 ?>
                    ...
                    <li>
                        ...
                        <div class="dropdown">
                            <span class="dropdown-toggle " data_link="link" data="<?php echo $row2["id_filtro"];?>" onclick4="captar_filtro(this);" id="filtroTalla" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="filtroTalla">
                                ...
                                if(mysqli_num_rows($result3))
                                {
                                    while($row3 = mysqli_fetch_assoc($result3))
                                    {
                                        ...
                                        <li>
                                            <?php 
                                            $itemm = isset($row3["nombre_item_filtro"]) ? $row3["nombre_item_filtro"] : $row3["nombre_item_categoria"];
                                            if(isset($id_cat)){?>
                                            <span data_link="link_row" data="<?php echo $row2["id_filtro"];?>" tipo = "<?php echo $id_tipo;?>" data2="<?php echo $row3["id_item_filtro"];?>" categoria="<?php echo  $id_cat;?>" marca="0"  subcategoria="<?php echo  $id_page_table;?>" cantidades="<?php echo $cantidad_paginador;?>" onclick="captar_filtro_descuento(this);" onclick2="setCookie('filtro_<?php echo $i?>','<?php echo $row3["nombre_item_filtro"]; ?>','1')"><?php echo ucfirst(strtolower($itemm)); ?>
                                            </span>
                                            <?php }
                                            else{
                                            ?>   
                                                <span data_link="link_row" data="<?php echo $row2["id_filtro"];?>" tipo = "<?php echo $id_tipo;?>" data2="<?php echo $row3["id_item_filtro"];?>" categoria="" marca="0" subcategoria="" cantidades="<?php echo $cantidad_paginador;?>" onclick="captar_filtro_descuento(this);" onclick2="setCookie('filtro_<?php echo $i?>','<?php echo $row3["nombre_item_filtro"]; ?>','1')">
                                                <?php echo ucfirst(strtolower($row3["nombre_item_filtro"])); ?>
                                                </span>
                                            <?php }?> 
                                        </li>
                                        ...
                                        }else
                                        {
                                                  if($cantidad_marca == 0)
                                                  {
                                                    $resultf = $db_Full->select_sql("select m.url_page_tbl,
                                                            ...
                                                            id_marca 
                                                            from tbl_marcas m
   inner join tbl_tipos_marcas tmar on fkmarcas_tipos_marcas = id_marca and 
   fktipos_tipos_marcas =".$id_tipo." 
   inner join tbl_productos_marcas pm on pm.fkmarca_productos_marcas = id_marca and pm.fktipo_productos_marcas=".$id_tipo." 
   group by id_marca"); 
                                                          ...
                                                          ?>
                                                            <li>
                                                                <span href="<?php echo $BASE_URL.$url3;?>" data_link="link_row" tipo = "<?php echo $id_tipo;?>" data="<?php echo $row2["id_filtro"];?>" categoria="<?php echo  $id_cat;?>" subcategoria="<?php echo  $id_page_table;?>" cantidades="<?php echo $cantidad_paginador;?>" subcategoria="<?php echo  $id_page_table;?>" data2="<?php echo $row3["id_item_filtro"];?>" marca="<?php echo $row_subf["id_marca"]; ?>"  onclick="captar_filtro_descuento(this);"><?php echo ucfirst(strtolower($row_subf["nombre_marca"])); ?>
                                ...
                                { 
                                         ...
                                         $resultf = $db_Full->select_sql("select m.url_page_tbl,m.nombre_marca,id_marca from tbl_marcas m
   inner join tbl_tipos_marcas tmar on fkmarcas_tipos_marcas =id_marca and fktipos_tipos_marcas =".$id_tipo." inner join tbl_productos_marcas pm on pm.fkmarca_productos_marcas =id_marca and pm.fktipo_productos_marcas=".$id_tipo." group by id_marca"); 
                                          ...
                                          ?>
                                            <li>
                                                <span href="<?php echo $BASE_URL.$url3;?>" data_link="link_row" tipo="<?php echo $id_tipo;?>" data="<?php echo $row2["id_filtro"];?>" cantidades="<?php echo $cantidad_paginador;?>" categoria="<?php echo  $id_cat;?>" subcategoria="<?php echo  $id_page_table;?>" subcategoria="<?php echo  $id_page_table;?>" data2="<?php echo $row3["id_item_filtro"];?>" marca="<?php echo $row_subf["id_marca"]; ?>"  onclick="captar_filtro_descuento(this);"><?php echo strtolower($row_subf["nombre_marca"]); ?>
