...
$pais_facturacion_cli = $data2['pais_direccion_cli'];
$nombre_facturacion_cli = $data2['nombre_direccion_cli'];
$apellido_facturacion_cli = $data2['apellido_direccion_cli'];
$dir1_facturacion_cli = $data2['dir1_direccion_cli'];
$dir2_facturacion_cli = $data2['dir2_direccion_cli'];
$postal_facturacion_cli = $data2['postal_direccion_cli'];
$tel_facturacion_cli = $data2['tel_direccion_cli'];

$departamento_cli = $data2['fkdepartamento_cli'];
$provincia_cli = $data2['fkprovincia_cli'];
$distrito_cliente = $data2['fkdistrito_cli'];


$result1000 = $db_Full->select_sql("SELECT * from departamento ");
$result101 = $db_Full->select_sql("SELECT * from provincia ");
$result1020 = $db_Full->select_sql("SELECT * from distrito ORDER BY `nombre_distrito` ");
...
function provincia_id(id)
{
     $.ajax({
            type: "POST",
            url: "ubigeos.php?tipe=d",
            data : "provincia="+id,   
            success: function(data)
            {
               $("#distrito").html(data);
...
jQuery(document).ready(function($)
{
    ...
    $('.updateData').on('click', function(e){
        ...
        var departamento = document.cuenta.elements['departamento'];
        var provincia = document.cuenta.elements['provincia'];
        var distrito = document.cuenta.elements['distrito'];
        ...
        {
            $("#departamento").css("border-bottom-color", "#900");
            $("#departamento").css("border-top-color", "#900");
            $("#departamento").css("border-left-color", "#900");
            $("#departamento").css("border-right-color", "#900");
            $("#error_departamento").css("display", "block");
            return false;
        }else
        {
            $("#departamento").css("border-bottom-color", "#000");
            $("#departamento").css("border-top-color", "#000");
            $("#departamento").css("border-left-color", "#000");
            $("#departamento").css("border-right-color", "#000");
            $("#error_departamento").css("display", "none");
        }
        ...
        if(distrito.value == "")
        {
            $("#distrito").css("border-bottom-color", "#900");
            $("#distrito").css("border-top-color", "#900");
            $("#distrito").css("border-left-color", "#900");
            $("#distrito").css("border-right-color", "#900");
            $("#error_distrito").css("display", "block");
            return false;
        }else
        {
            $("#distrito").css("border-bottom-color", "#000");
            $("#distrito").css("border-top-color", "#000");
            $("#distrito").css("border-left-color", "#000");
            $("#distrito").css("border-right-color", "#000");
            $("#error_distrito").css("display", "none");
        }
        ...
        }else
        {
          ...
          $.ajax({
                  type: "POST",
                  url: "actualizar_direccion.php",
                  data : "pais="+$('#pais').val()+"&nombre="+$('#nombre').val()+"&apellidos="+$('#apellidos').val()+"&direccion_1="+$('#direccion_1').val()+"&direccion_2="+$('#direccion_2').val()+"&provincia="+$('#provincia').val()+"&codigo="+$('#codigo').val()+"&telefono="+$('#telefono').val()+"&departamento="+$('#departamento').val()+"&distrito="+$('#distrito').val(),
                  success: function(data)
                  {
...
<tr>
<td align="left" class="fuente_georgia font_size18" style="background-color:#000; color:#FFF; padding:15px">NUEVA DIRECCIÓN DE ENVÍO</td>
</tr>
</table>
...
<tr>
<td class="fuente_georgia font_size13">País</td>
...
<tr>
<td class="fuente_georgia font_size13" width="120">Nombres</td>
<td class="fuente_georgia font_size13">
<input type="text" name="nombre" id="nombre" value="<?php echo $nombre_facturacion_cli; ?>" style="width:100%; border:solid 1px #000; height:25px">
<div id="error_nombre" style="display:none;color:#F00;" class="fuente_georgia font_size13">Ingrese sus Nombres</div>
</td>
</tr>
<tr><td height="30"></td></tr>
<tr>
<td class="fuente_georgia font_size13" width="120">Apellidos</td>
<td class="fuente_georgia font_size13">
<input type="text" name="apellidos" id="apellidos" value="<?php echo $apellido_facturacion_cli; ?>" style="width:100%; border:solid 1px #000; height:25px">
...
<tr>
<td class="fuente_georgia font_size13">Departamento</td>
<td class="fuente_georgia font_size13">
<select type="text" onchange="departamento_id(this.value)" name="departamento" id="departamento"  style="width:100%;background: url(images/combobox.jpg) no-repeat right #FFF; overflow: hidden;border:solid 1px #000; height:25px;-webkit-appearance: none;">

        <option value="" <?php if($departamento_cli==""){ echo "selected"; } ?> >Seleccione</option>
        <?php
        while ($row1000= mysqli_fetch_array($result1000))
        {
        ?>
        <option value="<?php echo $row1000['id_departamento']; ?>" <?php if($departamento_cli==$row1000['id_departamento']){ echo "selected"; } ?> ><?php echo $row1000['nombre_departamento']; ?></option>
        <?php
        }
        ?>
    </select>
    <div id="error_departamento" style="display:none;color:#F00;" class="fuente_georgia font_size13">Ingrese su Departamento</div>
</td>
</tr>
<tr><td height="30"></td></tr>
...
<tr>
<td class="fuente_georgia font_size13">Provincia</td>
<td class="fuente_georgia font_size13">
<select type="text" name="provincia" onchange="provincia_id(this.value)" id="provincia"  style="width:100%;background: url(images/combobox.jpg) no-repeat right #FFF; overflow: hidden;border:solid 1px #000; height:25px;-webkit-appearance: none;">

        <option value="" <?php if($provincia_cli==""){ echo "selected"; } ?> >Seleccione</option>
        <?php
        while ($row101= mysqli_fetch_array($result101))
        {
        ?>
        <option value="<?php echo $row101['id_provincia']; ?>" <?php if($provincia_cli==$row101['id_provincia']){ echo "selected"; } ?> ><?php echo $row101['nombre_provincia']; ?></option>
        <?php
        }
        ?>
    </select>
...
<tr>
<td class="fuente_georgia font_size13">Distrito</td>
<td class="fuente_georgia font_size13">
<select type="text" name="distrito" id="distrito"  style="width:100%;background: url(images/combobox.jpg) no-repeat right #FFF; overflow: hidden;border:solid 1px #000; height:25px;-webkit-appearance: none;">

        <option value="" <?php if($distrito_cliente ==""){ echo "selected"; } ?> >Seleccione</option>
        <?php
        while ($row1020= mysqli_fetch_array($result1020))
        {
        ?>
        <option value="<?php echo $row1020['id_distrito']; ?>" <?php if($distrito_cliente==$row1020['id_distrito']){ echo "selected"; } ?> >
        <?php echo $row1020['nombre_distrito']; ?>
        </option>
        <?php
        }
        ?>
    </select>
    <div id="error_distrito" style="display:none;color:#F00;" class="fuente_georgia font_size13">Ingrese su Distrito</div>
</td>
</tr>
<tr><td height="30">
...
<tr>
<td class="fuente_georgia font_size13">Dirección 1</td>
<td class="fuente_georgia font_size13">
...
<tr>
<td class="fuente_georgia font_size13">Dirección 2</td>
<td class="fuente_georgia font_size13"><input type="text" name="direccion_2" id="direccion_2" value="<?php echo $dir2_facturacion_cli; ?>" style="width:100%; border:solid 1px #000; height:25px"></td>
</tr>
<tr><td height="30"></td></tr>


<tr>
<td class="fuente_georgia font_size13">Código Postal</td>
<td class="fuente_georgia font_size13">
...
<tr><td height="30"></td></tr>
<tr>
<td class="fuente_georgia font_size13">Teléfono</td>
<td class="fuente_georgia font_size13">
...
<div class="left_crear_cuenta">
    ...
    <td align="center">
        ...
        <div class="boton_crear_cuenta fuente_georgia font_size12" style="cursor: pointer">CANCELAR</div>
        </a>
    </td>
    </tr>
    </table>
