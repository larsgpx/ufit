...
class mantenimiento_ajax{
	...
	function verificar_url_productos(){ 
		...
		$result 		= $db_Full->select_sql("SELECT url_page_tbl 
												FROM tbl_page 
												WHERE url_page_tbl like '%".$_POST['url']."%'");
	...
	function filtros_productos(){
		...
		$id_categoria          		= $_POST['data_catego'];
		$data2              		= array();
		$BASE_URL           		= $_POST['url'];
		$db_Full 		    		= new db_model(); 
		$db_Full           			-> conectar(); 
		...
		if(isset($_POST['filtro']) && $_POST['filtro'] != "" )
		{
			if($_POST['marca'] == "0")
			{
				...
				$if_subcategoria = ($_POST['subcategoria'] != "") ? " fktipo_productos_categorias  = ".$_POST['tipo']." and fksubcategoria_productos_categorias = ".$_POST['subcategoria']: '';	
				...
				if($id_categoria == 0){
					...
					$sql = "SELECT  fil4.nombre_marca,
							    ...
							    descuento_producto 
							    from tbl_productos
							    inner join tbl_productos_categorias fil on
								fkproducto_productos_categorias  = id_producto and
								fktipo_productos_categorias      = ".$_POST['tipo']." and
								fkcategoria_productos_categorias    = ".$_POST['filtro']." and
								fksubcategoria_productos_categorias =".$_POST['subfiltro']." 
					...
					$sql = "SELECT  fil4.nombre_marca,
					    ...
					    $sql = "SELECT  fil4.nombre_marca,
										...
										if($_POST['filtro']!="")
										{
											...
											$sql.= " ".$consulta_categoria." join tbl_productos_categorias fil on
											fkproducto_productos_categorias     = id_producto and
											fktipo_productos_categorias         = ".$_POST['tipo']." and
											fkcategoria_productos_categorias    = ".$_POST['filtro']." and
											fksubcategoria_productos_categorias =".$_POST['subfiltro']."  ";
