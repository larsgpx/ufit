...
<div class="content">
  ...
  <div class="page-header">
    <h1 class="title">Banner de Ofertas</h1>
      <ol class="breadcrumb">
...
<div class="container-padding">
  ...
  <div class="row">
     ...
     <?php 
												...
												$obj   = new Bannerofertas($idioma, $msgbox, $sesion->getUsuario());
												// Create new Proyectos
												if(!isset($_GET['actioncat'])){
													if($_GET['action']){
														$accion = $_GET['action']."Bannerofertas";	
														$obj->$accion();
													}else{
														$obj->listBannerofertas();
													}
											   }?>
