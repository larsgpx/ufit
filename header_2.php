...
<div class="detalle_marcas">
        ...
        $imagen10 = getimagesize("webroot/archivos/".$row_banner_marcas10["foto_tipo_img"]);
        $ancho10 = $imagen10[0];
        $alto10 = $imagen10[1];
        ?>
            <div class="item_fotos">
            <a href="<?php echo $row_banner_marcas10["link_tipo_img"];?>"><img src="webroot/archivos/<?php echo $row_banner_marcas10["foto_tipo_img"];?>" <?php if($deviceType=="computer"){ ?> width="<?php echo $ancho10;?>" height="<?php echo $alto10;?>" <?php } ?> ></a>
            </div>
        <?php
        }
        ?>
