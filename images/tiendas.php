...
<section id="tiendas">
	<div class="container-center">
		<div class="col-6 fuente_georgia">
			<img src="images/tiendas.jpg" class="img-responsive padding-add" alt="">
			<h1 class="font_size28 section-title padding-add">Encuentra nuestras tiendas</h1>
			<p class="padding-add">Curabitur ullamcorper ultricies nisi. Nam eget dui. Etiam rhoncus. Maecenas tempus, tellus eget condimentum rhoncus, sem quam semper libero, sit amet adipiscing sem neque sed ipsum. Nam quam nunc, blandit vel, luctus pulvinar.</p>
		</div>
		<div id="locations" style="height: 450px;" class="col-6"></div>
	</div>
</section>
